...
PATCH_TEXTS := patch/texts.json $(wildcard patch/bag_return_locations*.json patch/item_names.json patch/item_descriptions.json patch/move_names.json patch/type_names.json patch/move_descriptions.json patch/ability_names.json patch/ability_descriptions.json) $(PATCH_BATCHES)
